...
Configures an Debian (10/11) or Ubuntu-Server LTS (20.04/22.04) as Freifunk-Dresden Server, that could be used as internet gateway an as basis to add further services.
...
- Notwendig ist eine Debian (10/11) oder Ubuntu-Server LTS (20.04/22.04) Installation.<br/>
