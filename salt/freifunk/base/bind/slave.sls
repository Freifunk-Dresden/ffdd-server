...
/lib/systemd/system/bind9.service:
  file.managed:
    - source: salt://bind/slave/lib/systemd/system/bind9.service
    - user: root
    - group: root
    - mode: 644
    - require:
...
/etc/bind/named.conf:
  file.managed:
    - source:
      - salt://bind/slave/etc/bind/named.conf
    - user: root
    - group: root
    - mode: 644
    - require:
...
/etc/bind/named.conf.options:
  file.managed:
    - source:
      - salt://bind/slave/etc/bind/named.conf.options
    - user: root
    - group: root
    - mode: 644
    - require:
...
/etc/bind/named.conf.default-zones:
  file.managed:
    - source:
      - salt://bind/slave/etc/bind/named.conf.default-zones
    - user: root
    - group: root
    - mode: 644
    - require:
...
/etc/bind/named.conf.local:
  file.managed:
    - source:
      - salt://bind/slave/etc/bind/named.conf.local
    - user: root
    - group: root
    - mode: 644
    - require:
